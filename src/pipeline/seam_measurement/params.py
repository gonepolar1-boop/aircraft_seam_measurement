...
_BUILTIN_DEFAULTS: dict[str, float | int] = {
    "seam_step": 4,
    "section_half_length_px": 4.0,
    "min_section_points": 24,
    ...
    "top_surface_min_segment_points": 6,
    "top_surface_search_radius_ratio": 3.0,
    "top_surface_smooth_window": 5,
    "top_surface_outlier_u_ratio": 0.5,
